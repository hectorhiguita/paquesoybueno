...
variable "twilio_phone_number"  { type = string; default = "" }
variable "vapid_public_key"     { type = string; sensitive = true; default = "" }
variable "vapid_private_key"    { type = string; sensitive = true; default = "" }
